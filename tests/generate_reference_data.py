...
def make_time_dependent_test_data():
    ...
    dst_file_path = os.path.join(test_dir, 'reference_data', os.path.basename(src_file_path))
    ...
    # Make lon in -pi:pi domain, as otherwise the 0-2 pi boundary can confuse comparison.
