...
This will enable you to import HUXt in any file when the environment is activated.

Then the examples can be accessed through

```
>>jupyter lab notebook/HUXt_examples.ipynb
```
...
Barnard and Owens. (2022), _HUXt - An open source, computationally efficient reduced-physics solar wind model, written in Python_, Frontiers in Physics [10.3389/fphy.2022.1005621](https://doi.org/10.3389/fphy.2022.1005621)

Owens et al. (2020), _A Computationally Efficient, Time-Dependent Model of the Solar Wind for Use as a Surrogate to Three-Dimensional Numerical Magnetohydrodynamic Simulations_, Sol Phys, DOI:[10.1007/s11207-020-01605-3.svg](https://doi.org/10.1007/s11207-020-01605-3)
