...
class Observer:
    ...
    Allowed bodies are Earth, Venus, Mercury, STEREO-A and STEREO-B. After 2020, the ephemeris positions for STEREO-A
    and STEREO-B are from the predicted ephemeris. The HDF5 file of ephemeris data was generated by code available at
     the following repository: https://github.com/LukeBarnard/huxt_ephemeris
